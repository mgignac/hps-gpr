...
limit, and the fitted per-dataset responses. The upper panels show how
the two input data sets respond individually, while the lower panel shows the combined
Gaussian signal representation. The no-refit version is used here because it is the
clearest visualization of the shared-likelihood method before the extra complication of
toy-by-toy GP retraining is introduced.}
