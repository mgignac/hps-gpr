...
### 1) Generate SLURM scripts (90% CL, 10k toys)

```bash
hps-gpr slurm-gen --config study_configs/config_2015_blind1p96_90CL_10k_injection.yaml --n-jobs 126 --job-name hps2015_90CL_w196 --partition milano --account hps:hps-prod --time 24:00:00 --memory 8G --output submit_2015_90CL_w196.slurm

hps-gpr slurm-gen --config study_configs/config_2016_10pct_blind1p96_90CL_10k_injection.yaml --n-jobs 156 --job-name hps2016_10pct_90CL_w196 --partition milano --account hps:hps-prod --time 24:00:00 --memory 8G --output submit_2016_10pct_90CL_w196.slurm

hps-gpr slurm-gen --config study_configs/config_2015_2016_combined_blind1p96_90CL_10k_injection.yaml --n-jobs 106 --job-name hps2015_2016_comb_90CL_w196 --partition milano --account hps:hps-prod --time 24:00:00 --memory 8G --output submit_2015_2016_combined_90CL_w196.slurm
```
...
```bash
./submit_all.sh submit_2015_90CL_w196.slurm submit_2016_10pct_90CL_w196.slurm submit_2015_2016_combined_90CL_w196.slurm
```

### 3) Combine and make global-significance suites

```bash
hps-gpr slurm-combine --output-dir outputs/study_2015_w1p96_90CL
hps-gpr slurm-combine --output-dir outputs/study_2016_10pct_w1p96_90CL
hps-gpr slurm-combine --output-dir outputs/study_2015_2016_combined_w1p96_90CL
```
...
```bash
hps-gpr inject --config study_configs/config_2015_blind1p96_90CL_10k_injection.yaml --dataset 2015 --masses 0.030,0.040,0.050,0.060,0.070,0.080,0.090
hps-gpr inject --config study_configs/config_2016_10pct_blind1p96_90CL_10k_injection.yaml --dataset 2016 --masses 0.040,0.060,0.080,0.100,0.120,0.140,0.160
```
